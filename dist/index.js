  ...
  _createClass(Matrix, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          data = _props.data,
          classesForAllCells = _props.classesForAllCells;
...
Matrix.propTypes = {
  columnDefinitions: _propTypes2.default.array.isRequired,
  data: _propTypes2.default.array.isRequired,
  classesForAllCells: _propTypes2.default.func
};
...
var _draggableHandle = __webpack_require__(15);
...
var Column = function (_Component) {
  ...
  _createClass(Column, [{
    key: 'resize',
    value: function resize(resizeTo) {
      this.setState({
        width: resizeTo + 'px'
      });
    }
    ...
    value: function render() {
      ...
      var c = this.props.columnDef;
      var _props = this.props,
          data = _props.data,
          scrollable = _props.scrollable,
          classesForAllCells = _props.classesForAllCells;

      var style = this.state.width ? { width: this.state.width } : {};

      return _react2.default.createElement(
        'div',
        { key: c.label, className: 'column', style: style },
        _react2.default.createElement(
          'div',
          {
          ...
          _react2.default.createElement(_draggableHandle2.default, { scrollable: scrollable, resize: function resize(resizeTo) {
              return _this2.resize(resizeTo);
            } })
        ),
        data.map(function (row, index) {
          var value = _lodash2.default.get(row, c.field);
          var classes = _lodash2.default.isString(c.classes) && c.classes || '';
          classes = _lodash2.default.isFunction(c.classes) ? c.classes(row) : classes;

          if (c.formatter && _lodash2.default.isFunction(c.formatter)) {
          ...
          return _react2.default.createElement(
            ...
            c.component ? (0, _react.createElement)(c.component, { value: value, row: row, field: c.field }) : _react2.default.createElement(
              'span',
              null,
              value
            )
...
Column.propTypes = {
  columnDef: _propTypes2.default.object.isRequired,
  data: _propTypes2.default.array.isRequired,
...
var DraggableHandle = function (_Component) {
  _inherits(DraggableHandle, _Component);

  function DraggableHandle(props) {
    _classCallCheck(this, DraggableHandle);

    var _this = _possibleConstructorReturn(this, (DraggableHandle.__proto__ || Object.getPrototypeOf(DraggableHandle)).call(this, props));
  ...
  _createClass(DraggableHandle, [{
    ...
    value: function start(e) {
      var mouseDelta = e.clientX - e.target.offsetLeft;
    ...
    value: function resize(clientX) {
      ...
      var mouseDelta = isEnd ? this.state.mouseDelta : this.props.scrollable ? 0 : this.state.mouseDelta;

      var diff = clientX + mouseDelta - this.state.startingFromX;
      var resizeTo = this.state.initialWidth + diff;
      if (resizeTo < 100) {
        resizeTo = 100;
      }
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          onDrag: function onDrag(e) {
            return _this2.resize(e.clientX);
          },
